                                ...
                                {signals.length === 0 ? (
                                    <tr>
                                        <td colSpan="6" className="py-2 px-4 border-b text-center">
                                            No signals available. <button className="ml-2 px-4 py-2 bg-blue-500 text-white rounded">Create Signal</button>
                                        </td>
                                    </tr>
                                ) : (
                                    signals.map((signal, index) => (
                                        <tr key={index}>
                                            ...
                                            <td className={`py-2 px-4 border-b ${signal.status === 'ongoing' ? 'text-yellow-500' : 'text-gray-600'}`}>{signal.status}</td>
                                        </tr>
                                    ))
                                )}
                            </tbody>
